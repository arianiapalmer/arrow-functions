...
// When joe.scope() is invoked, "this" refers to the new instantiation of Student, called joe

// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked, "this" refers to the window, since it is scoped to the window

// 3. Explain why "this" is different when an arrow function is used.
// "this" is different when an arrow function is used because arrow functions don't have their own bindings to this. 
